...
export default function ViewMeterials() {
    ...
    const [delAllids, setAlldelIds] = useState([])
    ...
    let getAllCheckValue = (event) => {
        if (event.target.checked) {
            ...
            if (!delAllids.includes(event.target.value)) {
                ...
                // console.log([...delAllids, event.target.value])
                //[1,2,3,4]
            }
    ...
    return (
        <>
            ...
            <div className="w-full ml-5 h-[610px] ">
                <div className="max-w-[920px] mx-auto  py-2">
                    ...
                    <div className={` rounded-lg border border-gray-300 px-5 py-5 max-w-[1220px] mx-auto mt-10 ${activeFilter ? "hidden" : "block"}`}>
                        ...
                        <form className="flex max-w-sm" onSubmit={materialview}>
                                                        ...
                                                        return (
                                                            <tr class="bg-white  dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                                ...
                                                                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                                                    ...
                                                                    <div class="py-4">
                                                                        <div class="text-base font-semibold">{item.materialName}</div>
