...
export default function AddCategory() {
  ...
  useEffect(()=>{
    if(id){
        ...
        .then((res)=>res.data)
        .then((finalres)=>{
          console.log("heloooo",finalres.categoryview)
          setCategoryName(finalres.categoryview.categoryName)
           setOrder(finalres.categoryview.categoryOrder)
          setImagePre(finalres.staticPath+finalres.categoryview.categoryImage)
        })
      }
  ...
  return (
    <section className="w-full pl-5 pr-16 ml-12">
