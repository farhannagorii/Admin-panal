...
import { loginContext } from '../Pages/Maincontext'
    ...
    return (
        <div className="absolute z-50 right-1 top-7 mt-2 hidden group-hover:block p-4">
            ...
            <div className="w-48 text-gray-900 bg-white border border-gray-200 rounded-lg shadow-2xl ">
                ...
                <button onClick={() => setuser(null)} type="button" className="relative inline-flex items-center w-full px-4 py-3 text-sm font-medium border-t border-black rounded-b-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
