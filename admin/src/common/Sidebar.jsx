...
export default function Sidebar() {
  ...
  return (
    <>
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 w-41 h-screen transition-transform -translate-x-full sm:translate-x-0   "
        aria-label="Sidebar"
      >
          ...
          <Link to={"/home"}>
            <div className="flex items-center ps-2.5 mb-5 border-b border-slate-400 pb-7">
              <img
                ...
                // src="https://images.squarespace-cdn.com/content/v1/5cb0a84934c4e2eb7d8169ec/1626360426664-LFTXLIFF86GD0Z7VFTI1/Admin+Panel.png"
                
                className="img-fluid h-[89px] w-[150px] pl-3 ml-5 pt-2"
                alt="Flowbite Logo"
              />
