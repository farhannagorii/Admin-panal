...
export default function SliderView() {
  ...
  let sliderdata = () => {
    axios.get(`${apiBaseUrl}/slider/view`)
      .then((res) =>{
     setsliderdatas(res.data.sliderdataview)
    console.log(res.data.sliderdataview)
      })
  }
  ...
  return (
    <section className="w-full">
      ...
      <nav className="flex border-b-2 w-full" aria-label="Breadcrumb">
                    ...
                    {sliderdatas?.map((item) => {
                      return (<tr class="bg-white  dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                          ...
                          <div class="py-4">
                            <div class="text-base font-semibold">{item.sliderName}</div>
